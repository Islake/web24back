...
('Beef Pho', 13.99, 'A fragrant and flavorful Vietnamese noodle soup made with thinly sliced beef, rice noodles, bean sprouts, basil, and lime, all served in a rich and aromatic beef broth. Our beef pho is a comforting and nourishing dish that''s perfect for any occasion.', 'gluten, soy', 'Vietnamese', 'beef_pho.jpeg'),
...
VALUES
('Monday', 1, 'Vegetable Pad Thai', 'Beef Pho', NULL, NULL, NULL, NULL),
('Tuesday', 1, 'Tofu Teriyaki Bowl', 'Ox Tripe Stew', NULL, NULL, NULL, NULL),
('Wednesday', 1, 'Tofu Teriyaki Bowl', 'Ox Tripe Stew', NULL, NULL, NULL, NULL),
('Thursday', 1, 'Tofu Teriyaki Bowl', 'Chicken Katsu', NULL, NULL, NULL, NULL),
('Friday', 1, 'Tofu Teriyaki Bowl', 'Ox Tripe Stew', NULL, NULL, NULL, NULL),
('Saturday', 1, 'Chicken Katsu', 'Ox Tripe Stew', NULL, NULL, NULL, NULL),
('Sunday', 1, 'Tofu Teriyaki Bowl', 'Vegetable Pad Thai', NULL, NULL, NULL, NULL),
('Monday', 2, 'Vegetable Pad Thai', 'Beef Pho', NULL, NULL, NULL, NULL),
('Tuesday', 2, 'Tofu Teriyaki Bowl', NULL, NULL, NULL, NULL, NULL),
('Wednesday', 2, 'Tofu Teriyaki Bowl', 'Ox Tripe Stew', NULL, NULL, NULL, NULL),
('Thursday', 2, 'Tofu Teriyaki Bowl', 'Chicken Katsu', NULL, NULL, NULL, NULL),
('Friday', 2, 'Tofu Teriyaki Bowl', 'Ox Tripe Stew', NULL, NULL, NULL, NULL),
('Saturday', 2, 'Chicken Katsu', NULL, NULL, NULL, NULL, NULL),
('Sunday', 2, 'Tofu Teriyaki Bowl', 'Vegetable Pad Thai', NULL, NULL, NULL, NULL);
